...
patchFileFirstMatch(path.join(scriptsDir, "browser-client.mjs"), {
  ...
  oldTexts: [
    ...
    },
    {
      ...
      newText: String.raw`codexLinuxChromeUserDataDirectories=()=>H7()==="linux"?[z7(W7(),".config","BraveSoftware","Brave-Browser"),z7(W7(),".config","google-chrome"),z7(W7(),".config","google-chrome-beta"),z7(W7(),".config","google-chrome-unstable"),z7(W7(),".config","chromium"),z7(W7(),".config","thorium")]:[Rd]`,
    },
    {
